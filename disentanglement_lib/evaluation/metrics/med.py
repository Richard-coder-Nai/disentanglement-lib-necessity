...
"""Implementation of Mutual information based Entropy Disentanglement.
...
def compute_med(ground_truth_data, representation_function, random_state,
  ...
  mus_test, ys_test = utils.generate_batch_factor_code(
      ...
      random_state, batch_size)
  scores = _compute_med(mus_train, ys_train, mus_test, ys_test)
  return scores


def _compute_med(mus_train, ys_train, mus_test, ys_test):
...
def compute_importance_mi(x_train, y_train, x_test, y_test):
  ...
  for i in range(num_factors):
    ...
    x_train_scale = x_train.T
    x_test_scale = x_test.T
